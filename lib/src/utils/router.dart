...
import 'package:flutter_riverpod_base/src/feature/details/view/product_item_details.dart';
...
final GoRouter router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: ProductsItemDetails.routePath,
      builder: (BuildContext context, GoRouterState state) {
        return const ProductsItemDetails();
      },
    ),
  ],
);
